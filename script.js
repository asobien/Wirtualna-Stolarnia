...
recordRef.once("value", (snapshot) => {
  ...
  let editForm = `
              ...
              <input type="text" class="edit-input" id="editWoodSerialNumber" placeholder="Numer Seryjny" value="${
                record.serialNumber || ""
              }" required>
              <input type="text" class="edit-input" id="editWoodName" placeholder="Nazwa" value="${
                record.name || ""
              }" required>
              <input type="text" class="edit-input" id="editWoodSpecies" placeholder="Gatunek" value="${
                record.species || ""
              }">
              <input type="text" class="edit-input" id="editWoodType" placeholder="Typ (P lub D)" value="${
                record.type || ""
              }">
              <input type="text" class="edit-input" id="editWoodShape" placeholder="Kształt" value="${
                record.shape || ""
              }">
              <input type="" class="edit-input" id="editWoodPurchaseDate" placeholder="Data Zakupu" value="${
                record.purchaseDate || ""
              }">
              <input type="text" class="edit-input" id="editWoodPurchasedFrom" placeholder="Zakupione od" value="${
                record.purchasedFrom || ""
              }">
              <input type="text" class="edit-input" id="editWoodYearCut" placeholder="Rok Ścięcia" value="${
                record.yearCut || ""
              }">
              <input type="text" class="edit-input" id="editWoodMoisture1" placeholder="Wilgotność 1 (%)" value="${
                record.moisture1 || ""
              }">
              <input type="text" class="edit-input" id="editWoodMoisture2" placeholder="Wilgotność 2 (%)" value="${
                record.moisture2 || ""
              }">
              <input type="text" class="edit-input" id="editWoodMoisture3" placeholder="Wilgotność 3 (%)" value="${
                record.moisture3 || ""
              }">
              <input type="text" class="edit-input" id="editWoodMeasurer" placeholder="Osoba mierząca" value="${
                record.measurer || ""
              }">
              <input type="text" class="edit-input" id="editWoodMoistureMeter" placeholder="Wilgotnościomierz" value="${
                record.moistureMeter || ""
              }">                    
              <input type="text" class="edit-input" id="editWoodHeight" placeholder="Wysokość" value="${
                record.height || ""
              }">
              <input type="text" class="edit-input" id="editWoodWidth" placeholder="Szerokość" value="${
                record.width || ""
              }">
              <input type="text" class="edit-input" id="editWoodThickness" placeholder="Grubość" value="${
                record.thickness || ""
              }">
